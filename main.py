...
def getArticles():
  ...
  payload = {}
  headers = {'Authorization': 'DT-Fenix-Token ' + fenixToken['token']}
...
def getCategories():
  ...
  for i in range(len(response)):
    category = {"id": response[i]['id'], "name": response[i]['text']}
...
def newArticle():
  ...
  payload = json.dumps({
      ...
      "data": [{
          ...
          "UUidDepartamento":
          "1f0cf10b-f3e4-462e-88fe-61a461385d4b",
          "UUidSite":
          "fe0f60c2-26e6-4bd6-848e-ce25271a8a5b",
          "active":
          True
      }],
      "method":
